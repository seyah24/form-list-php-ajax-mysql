    ...
    <table style="width:100%">
      <tr>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <p><b>Địa chỉ:</b></p>
            <select class="btn btn-default dropdown-toggle" name="tinhtp" id="tinhtp" onchange="FetchTTP(this.value)" required>
                <option value="">Chọn Tỉnh Thành phố</option>
                    <?php
                        ...
                        while($row=$record->fetch_assoc()){
                            echo '<option value='.$row['TTPID'].'>'.$row['TenTinhTPh'].'</option>';}
                    } ?>
            </select>                    
                <select class="btn btn-default dropdown-toggle" id="quanhuyen" name="quanhuyen" onchange="FetchQH(this.value)"  required>
